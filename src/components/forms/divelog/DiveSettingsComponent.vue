<template>
  <div class="bg-gray-100 w-1/4 p-6">
    ...
    <div class="mb-4">
        ...
        <input type="number" id="diveNumber" v-model="diveNumber" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>

    <!-- Dive Date -->
    <div class="mb-4">
        <label for="diveDate" class="block text-gray-700 text-sm font-bold mb-2">Date :</label>
        <input type="date" id="diveDate" v-model="diveDate" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>

    <!-- Dive Location -->
    <div class="mb-4">
        <label for="diveLocation" class="block text-gray-700 text-sm font-bold mb-2">Site de plongée :</label>
        <input type="text" id="diveLocation" v-model="diveSite" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="number" id="depth" v-model="depth" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>

    <!-- Dive Duration -->
    <div class="mb-4">
        <label for="diveDuration" class="block text-gray-700 text-sm font-bold mb-2">Durée de plongée (min) :</label>
        <input type="number" id="diveDuration" v-model="durationDive" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>

    <!-- Return Surface Time -->
    <div class="mb-4">
        <label for="returnSurfaceTime" class="block text-gray-700 text-sm font-bold mb-2">Retour surface (h/min) :</label>
        <input type="text" id="returnSurfaceTime" v-model="surfaceReturn" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>

    <!-- Decompression Stop -->
    <div class="mb-4">
        <label for="decompressionStop" class="block text-gray-700 text-sm font-bold mb-2">Palier :</label>
        <input type="text" id="decompressionStop" v-model="decompressionStop" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    </div>
