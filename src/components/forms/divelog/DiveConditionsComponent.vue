<template>
    <div class="bg-gray-100 w-1/4 p-6">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="airTemperature" v-model="airTemperature" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>

        <!-- Water Temperature -->
        <div class="mb-4">
            <label for="waterTemperature" class="block text-gray-700 text-sm font-bold mb-2">Température de l'eau (°C) :</label>
            <input type="number" id="waterTemperature" v-model="waterTemperature" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea id="observationNotes" v-model="observations" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
        </div>
    </div>
</template>
